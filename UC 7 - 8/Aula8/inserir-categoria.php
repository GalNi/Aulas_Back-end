...
if($inserir_categoria){
    echo"Cadastro efetuado com sucesso <a href='cadastra-categoria.php'><i class='fa-solid fa-arrow-left'></i></a>";
}else{
    echo"Erro ao cadastrar categoria <a href='cadastra-categoria.php'><i class='fa-solid fa-arrow-left'></i></a>";
}